	...
	inout bit<32> b)
{
	...
	table choose_action {
		...
		/* 4096 units collective channels * 2 options */
		size = 8192;
	}
	...
	inout ingress_intrinsic_metadata_for_tm_t ig_tm_md)
{
	...
	apply {
		...
		agg00.apply(hdr, meta, hdr.aggregate.val00, hdr.aggregate.val01);
		agg01.apply(hdr, meta, hdr.aggregate.val02, hdr.aggregate.val03);
		agg02.apply(hdr, meta, hdr.aggregate.val04, hdr.aggregate.val05);
		agg03.apply(hdr, meta, hdr.aggregate.val06, hdr.aggregate.val07);
		agg04.apply(hdr, meta, hdr.aggregate.val08, hdr.aggregate.val09);
		agg05.apply(hdr, meta, hdr.aggregate.val10, hdr.aggregate.val11);
		agg06.apply(hdr, meta, hdr.aggregate.val12, hdr.aggregate.val13);
		agg07.apply(hdr, meta, hdr.aggregate.val14, hdr.aggregate.val15);
		agg08.apply(hdr, meta, hdr.aggregate.val16, hdr.aggregate.val17);
		agg09.apply(hdr, meta, hdr.aggregate.val18, hdr.aggregate.val19);
		agg10.apply(hdr, meta, hdr.aggregate.val20, hdr.aggregate.val21);
		agg11.apply(hdr, meta, hdr.aggregate.val22, hdr.aggregate.val23);
		agg12.apply(hdr, meta, hdr.aggregate.val24, hdr.aggregate.val25);
		agg13.apply(hdr, meta, hdr.aggregate.val26, hdr.aggregate.val27);
		agg14.apply(hdr, meta, hdr.aggregate.val28, hdr.aggregate.val29);
		agg15.apply(hdr, meta, hdr.aggregate.val30, hdr.aggregate.val31);
		agg16.apply(hdr, meta, hdr.aggregate.val32, hdr.aggregate.val33);
		agg17.apply(hdr, meta, hdr.aggregate.val34, hdr.aggregate.val35);
		agg18.apply(hdr, meta, hdr.aggregate.val36, hdr.aggregate.val37);
		agg19.apply(hdr, meta, hdr.aggregate.val38, hdr.aggregate.val39);
		agg20.apply(hdr, meta, hdr.aggregate.val40, hdr.aggregate.val41);
		agg21.apply(hdr, meta, hdr.aggregate.val42, hdr.aggregate.val43);
		agg22.apply(hdr, meta, hdr.aggregate.val44, hdr.aggregate.val45);
		agg23.apply(hdr, meta, hdr.aggregate.val46, hdr.aggregate.val47);
		agg24.apply(hdr, meta, hdr.aggregate.val48, hdr.aggregate.val49);
		agg25.apply(hdr, meta, hdr.aggregate.val50, hdr.aggregate.val51);
		agg26.apply(hdr, meta, hdr.aggregate.val52, hdr.aggregate.val53);
		agg27.apply(hdr, meta, hdr.aggregate.val54, hdr.aggregate.val55);
		agg28.apply(hdr, meta, hdr.aggregate.val56, hdr.aggregate.val57);
		agg29.apply(hdr, meta, hdr.aggregate.val58, hdr.aggregate.val59);
